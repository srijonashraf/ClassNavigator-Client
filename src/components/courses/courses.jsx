...
const Courses = ({ CourseAPIRefresh }) => {
  ...
  const { FetchAllCoursesByClass, FetchAllCoursesByClassRequest } =
    ContentStore();
            ...
            <div className="card shadow-sm border border-light-subtle">
              <div className="card-body">
                ...
                <Link
                  ...
                  className="nav-link"
                >
                  <p className="card-title cursorPointer fw-bold fs-5 mt-3 title-color">
                    {course.courseName}
                  </p>
                </Link>
    ...
    <div className="row">
      ...
      <div className="">
        ...
        <div className={`mb-4`}>
          {showAddNewCourse && (
            <AddNewCourses
              ShowAddNewCourseTrigger={handleShowAddNewCourse}
              setProgress={setProgress}
              CourseAPIRefresh={CourseAPIRefresh}
            />
          )}
        </div>
      </div>
